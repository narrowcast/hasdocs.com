...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Build.finished_at'
        db.alter_column('projects_build', 'finished_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Build.started_at'
        db.alter_column('projects_build', 'started_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Build.finished_at'
        db.alter_column('projects_build', 'finished_at', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Build.started_at'
        db.alter_column('projects_build', 'started_at', self.gf('django.db.models.fields.DateTimeField')())
