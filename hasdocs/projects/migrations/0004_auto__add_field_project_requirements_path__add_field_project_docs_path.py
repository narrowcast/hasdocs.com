...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.requirements_path'
        db.add_column('projects_project', 'requirements_path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Project.docs_path'
        db.add_column('projects_project', 'docs_path',
                      self.gf('django.db.models.fields.CharField')(default='docs', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.requirements_path'
        db.delete_column('projects_project', 'requirements_path')

        # Deleting field 'Project.docs_path'
        db.delete_column('projects_project', 'docs_path')
    ...
    models = {
        ...
        'projects.project': {
            ...
            'custom_domains': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['projects.Domain']", 'null': 'True', 'blank': 'True'}),
