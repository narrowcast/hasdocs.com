...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field custom_domains on 'Project'
        db.delete_table('projects_project_custom_domains')

        # Adding field 'Domain.project'
        db.add_column('projects_domain', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=20, to=orm['projects.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding M2M table for field custom_domains on 'Project'
        db.create_table('projects_project_custom_domains', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['projects.project'], null=False)),
            ('domain', models.ForeignKey(orm['projects.domain'], null=False))
        ))
        db.create_unique('projects_project_custom_domains', ['project_id', 'domain_id'])

        # Deleting field 'Domain.project'
        db.delete_column('projects_domain', 'project_id')
