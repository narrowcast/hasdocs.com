...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Project', fields ['url']
        db.create_unique('projects_project', ['url'])


        # Changing field 'Domain.name'
        db.alter_column('projects_domain', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['url']
        db.delete_unique('projects_project', ['url'])


        # Changing field 'Domain.name'
        db.alter_column('projects_domain', 'name', self.gf('django.db.models.fields.URLField')(max_length=200))
