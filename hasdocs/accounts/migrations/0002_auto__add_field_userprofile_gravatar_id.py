...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.gravatar_id'
        db.add_column('accounts_userprofile', 'gravatar_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.gravatar_id'
        db.delete_column('accounts_userprofile', 'gravatar_id')
