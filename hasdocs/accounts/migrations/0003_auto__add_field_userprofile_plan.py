...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('accounts_userprofile', 'plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Plan'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('accounts_userprofile', 'plan_id')
