...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BaseUser.github_access_token'
        db.delete_column('accounts_baseuser', 'github_access_token')

        # Deleting field 'BaseUser.heroku_api_key'
        db.delete_column('accounts_baseuser', 'heroku_api_key')

        # Adding field 'User.github_access_token'
        db.add_column('accounts_user', 'github_access_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'User.heroku_api_key'
        db.add_column('accounts_user', 'heroku_api_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BaseUser.github_access_token'
        db.add_column('accounts_baseuser', 'github_access_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'BaseUser.heroku_api_key'
        db.add_column('accounts_baseuser', 'heroku_api_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'User.github_access_token'
        db.delete_column('accounts_user', 'github_access_token')

        # Deleting field 'User.heroku_api_key'
        db.delete_column('accounts_user', 'heroku_api_key')
